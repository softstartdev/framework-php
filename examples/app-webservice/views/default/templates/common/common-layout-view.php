...
<html>
    <head>
        ...
        <link href="<?= getImageTemplate('FAVICON.png') ?>" rel="shortcut icon" />

        <!-- jquery -->
        <script src='<?= getPathLibrary() ?>/jquery/jquery.min.js' type='text/javascript'></script>
        
        <!-- bootstrap -->
        <link href="<?= getPathLibrary() ?>/bootstrap/css/bootstrap.css" rel="stylesheet">
        <link href="<?= getPathLibrary() ?>/bootstrap/css/bootstrap-theme.css" rel="stylesheet">
        <script src="<?= getPathLibrary() ?>/bootstrap/js/bootstrap.js"></script>

        <!-- morris -->
        <link href="<?= getPathLibrary() ?>/morris/morris.css" rel="stylesheet">
        <script src="<?= getPathLibrary() ?>/morris/morris.min.js"></script>

        <!-- raphael -->
        <script src="<?= getPathLibrary() ?>/raphael/raphael.min.js"></script>
        <!--
        <script src="http://cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>
        -->
        
        <!-- moment -->
        <script src="<?= getPathLibrary() ?>/moment/moment.min.js"></script>
        <script src="<?= getPathLibrary() ?>/moment/locale/es.js"></script>

        <!-- bootstrap-datetimepicker -->
        <script src="<?= getPathLibrary() ?>/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
        <link rel="stylesheet" href="<?= getPathLibrary() ?>/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css" />
        
        <!-- HTML5 shim and Respond.js for IE8 support of HTML5 elements and media queries -->
        <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
        <!--[if lt IE 9]>
          <script src="<?= getPathLibrary() ?>/html5shiv/html5shiv.min.js"></script>
          <script src="<?= getPathLibrary() ?>/respond/respond.min.js"></script>
        <![endif]-->
        
        <!-- bootbox -->
        <script src="<?= getPathLibrary() ?>/bootbox/bootbox.js"></script>
        
        <!-- font-awesome
        <link href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" integrity="sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" crossorigin="anonymous">
        -->
        <link href="<?= getPathLibrary() ?>/font-awesome/font-awesome.css" rel="stylesheet" type="text/css" />
        
        <!-- animate -->
        <link href="<?= getPathLibrary() ?>/animate/animate.css" rel="stylesheet" type="text/css" />
        
        <!-- owl carousel -->
        <script src="<?= getPathLibrary() ?>/owl-carousel/owl.carousel.js"></script>
        <link href="<?= getPathLibrary() ?>/owl-carousel/assets/owl.carousel.css" rel="stylesheet" type="text/css" />
        
        <!-- select2
        <link href="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.8/css/select2.min.css" rel="stylesheet" />
        <script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.8/js/select2.min.js"></script>
        -->
        <link href="<?= getPathLibrary() ?>/select2/4.0.8/css/select2.min.css" rel="stylesheet" />
        <script src="<?= getPathLibrary() ?>/select2/4.0.8/js/select2.min.js"></script>
        <!--
            <script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.13/js/select2.full.min.js" integrity="sha512-RtZU3AyMVArmHLiW0suEZ9McadTdegwbgtiQl5Qqo9kunkVg1ofwueXD8/8wv3Af8jkME3DDe3yLfR8HSJfT2g==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
        -->
        
        <!-- InputImage -->
        <script src="<?= getJsTemplate('InputImage') ?>" type="text/javascript"></script>
        
        <!-- InputFile -->
        <script src="<?= getJsTemplate('InputFile') ?>" type="text/javascript"></script>
